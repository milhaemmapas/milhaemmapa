...
def create_header():
    ...
    if st.session_state.page == 'home':
        ...
        with col1:
            st.markdown(
                """
                <div class="custom-button button-maps" onclick="window.location.href='?page=app&tab=maps'">
                    🗺️ Explorar Mapas
                </div>
                """, 
                unsafe_allow_html=True
            )
            if st.button("🗺️ Explorar Mapas", use_container_width=True, key="nav_maps"):
        ...
        with col2:
            st.markdown(
                """
                <div class="custom-button button-works" onclick="window.location.href='?page=app&tab=works'">
                    🏗️ Ver Obras
                </div>
                """, 
                unsafe_allow_html=True
            )
            if st.button("🏗️ Ver Obras", use_container_width=True, key="nav_works"):
                st.session_state.page = "app"
        ...
        with col3:
            st.markdown(
                """
                <div class="custom-button button-data" onclick="window.location.href='?page=app&tab=home'">
                    📊 Todos os Dados
                </div>
                """, 
                unsafe_allow_html=True
            )
            if st.button("📊 Todos os Dados", use_container_width=True, key="nav_data"):
                st.session_state.page = "app"
                st.session_state.active_tab = "🏠 Página Inicial"
                st.rerun()
...
# =====================================================
# Conteúdo da Página Inicial (Reutilizável)
# =====================================================
...
if st.session_state.page == 'home':
    ...
    # Determina qual aba mostrar baseado no estado
    if st.session_state.active_tab == "🏠 Página Inicial":
        with aba1:
            render_home_content()
    elif st.session_state.active_tab == "🏗️ Painel de Obras":
        with aba2:
            # =====================================================
            # 2) Painel de Obras
            # =====================================================
    ...
    elif st.session_state.active_tab == "🗺️ Milhã em Mapas":
        with aba3:
            # =====================================================
            # 3) Milhã em Mapas
            # =====================================================
